...
import { RiNextjsFill, RiRobot3Line } from "react-icons/ri"
      ...
      <div className="grid md:grid-cols-3 gap-10 items-center max-w-6xl mx-auto">
        ...
        >
          <div className="space-y-2">
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight">hαrsh vαirαgi</h1>
            <p className="text-lg sm:text-xl text-muted-foreground">Software Engineer | Full Stack Developer</p>
          </div>

          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 text-sm text-muted-foreground">
            <div className="flex items-center gap-1">
              <Mail className="h-4 w-4" />
              <a href="mailto:harshb7839@gmail.com">harshb7839@gmail.com</a>
            </div>
            <div className="flex items-center gap-1">
          ...
          <p className="text-muted-foreground text-sm sm:text-base">
            Self-taught developer skilled in building full stack web apps with Next.js,
            Nest.js, and mobile apps with React Native.
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3">
            ...
            <Link
              href="https://github.com/ourcodebase"
              target="_blank"
            >
            ...
            <Link
              href="mailto:harshb7839@gmail.com"
              target="_blank"
            >
              <Button variant="outline" size="sm" className="text-xs sm:text-sm">
            ...
            <Link
              href="https://dev.to/harshvairagi"
              target="_blank"
            >
              <Button variant="outline" size="sm" className="text-xs sm:text-sm">
                <FaDev className="h-3 w-3 sm:h-4 sm:w-4" />
              </Button>
            </Link>
            <Link
              href="https://www.linkedin.com/in/harshvairagi/"
              target="_blank"
            >
              <Button variant="outline" size="sm" className="text-xs sm:text-sm">
